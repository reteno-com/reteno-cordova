 ...
 */
@Plugin({
  pluginName: 'CordovaPluginRetenoFirebase',
  plugin: 'cordova-plugin-reteno-firebase',
  pluginRef: 'FirebasePlugin',
  repo: 'https://github.com/reteno-com/reteno-cordova/tree/main/cordova-plugin-reteno-firebase',
  platforms: ['Android', 'iOS'],
})
@Injectable()
export class AwesomeCordovaPluginFirebase extends AwesomeCordovaNativePlugin {
  /**
